...
export const Button = ({ 
  ...
  <button
    ...
    {...props}
  >
    <span className="flex flex-row items-center justify-center gap-2 pointer-events-none w-full">
      {loading ? <RotateCcw className="animate-spin shrink-0" size={size === 'sm' ? 14 : 18} /> : Icon && <Icon size={size === 'sm' ? 14 : 18} className="shrink-0" />}
