...
export const Payment = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const actualAmount = getConvertedPrice(selectedPlan.price, selectedCountry);
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-24 space-y-16">
        ...
        {!selectedPlan ? (
          <div className="grid md:grid-cols-3 gap-8">
            {allPlans.map(plan => {
              const convertedPrice = getConvertedPrice(plan.price, selectedCountry);
              ...
              >
                ...
                <p className="text-4xl font-black tracking-tighter">{convertedPrice.toLocaleString()} <span className="text-lg text-zinc-500">{currencyInfo.symbol}</span></p>
              </Card>
              );
            })}
          </div>
          ...
          >
            <div className="flex items-center justify-between p-4 bg-zinc-900/50 border border-zinc-800 rounded-2xl">
              ...
              <div className="text-right">
                <p className="text-2xl font-black text-primary">{getConvertedPrice(selectedPlan.price, selectedCountry).toLocaleString()} {getCurrencyInfo(selectedCountry).symbol}</p>
                <button 
            ...
            <div className="grid md:grid-cols-2 gap-6 items-start">
              ...
              <Card className="p-6 space-y-6 border-zinc-800 bg-zinc-900/30 backdrop-blur-xl">
                ...
                <div className="space-y-6">
                  ...
                  >
                    Payer {getConvertedPrice(selectedPlan.price, selectedCountry).toLocaleString()} {getCurrencyInfo(selectedCountry).symbol}
                  </Button>
